...
1. #### **¿Cómo se distribuye la cantidad de vuelos reservados por mes durante el año?**
   ...
   * **Aportación:**  
     * Como sugerencia la empresa podría realizar campañas de marketing teniendo en cuenta las festividades fomentando los viajes ya de por sí altos y haciendo campañas y bajando los precios para las temporadas bajas teniendo en cuenta los destinos con un clima cálido que es el contraste observado en el gráfico.  
       ...
       ![Gráfico 1](Evaluaciones\evaluacion_modulo_03\final_03\bda-modulo-3-evaluacion-final-Yael-Parra\imagenes.png\grafica1.png)
...
2. #### **¿Existe una relación entre la distancia de los vuelos y los puntos acumulados por los clientes?**
   ...
   *  **Lectura:**  
    ...
    ![Gráfico 2](Evaluaciones\evaluacion_modulo_03\final_03\bda-modulo-3-evaluacion-final-Yael-Parra\imagenes.png\grafica2.png)
...
3. #### **¿Cuál es la distribución de los clientes por provincia o estado?**
   ...
   * **Aportación:**  
    ...
    ![Gráfico 3](Evaluaciones\evaluacion_modulo_03\final_03\bda-modulo-3-evaluacion-final-Yael-Parra\imagenes.png\grafica3.png)
...
4. #### **¿Cómo se compara el salario promedio entre los diferentes niveles educativos de los clientes?**
   ...
   * **Lectura:**  
    ...
    ![Gráfico 4](Evaluaciones\evaluacion_modulo_03\final_03\bda-modulo-3-evaluacion-final-Yael-Parra\imagenes.png\grafica4.png)
...
5. #### **¿Cuál es la proporción de clientes con diferentes tipos de tarjetas de fidelidad?**
   ...
   *  **Aportación:**  
    ...
    ![Gráfico 5](Evaluaciones\evaluacion_modulo_03\final_03\bda-modulo-3-evaluacion-final-Yael-Parra\imagenes.png\grafica5.png)
